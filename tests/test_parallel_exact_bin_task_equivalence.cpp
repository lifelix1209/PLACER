...
int main() {
...

    {
        PipelineResult dst;
        PipelineResult src;
        src.performance.event_segmentation_seconds = 1.25;
        src.performance.te_alignment_seconds = 0.50;
        src.performance.te_blast_batches = 2;
        src.performance.te_blast_queries = 5;
        src.performance.te_blast_cache_hits = 3;
        src.performance.te_blast_cache_misses = 4;
        src.performance.pipeline_wall_seconds = 6.25;
        src.performance.pipeline_construction_seconds = 3.75;
        src.performance.bam_stream_wall_seconds = 5.75;
        src.performance.bin_processing_wall_seconds = 4.50;
        src.performance.finalization_seconds = 0.25;
        src.performance.gate1_preliminary_seconds = 0.125;
        src.performance.exact_bin_scan_seconds = 0.375;
        src.performance.segmentation_edit_distance_calls = 11;
        src.performance.segmentation_edit_distance_cache_hits = 7;
        src.performance.segmentation_seed_bins_total = 13;
        src.performance.segmentation_one_sided_searches = 2;
        dst.performance = src.performance;
        require(dst.performance.event_segmentation_seconds == 1.25, "performance segmentation seconds unavailable");
        require(dst.performance.te_alignment_seconds == 0.50, "performance TE seconds unavailable");
        require(dst.performance.te_blast_batches == 2, "performance BLAST batch count unavailable");
        require(dst.performance.te_blast_queries == 5, "performance BLAST query count unavailable");
        require(dst.performance.te_blast_cache_hits == 3, "performance cache hit count unavailable");
        require(dst.performance.te_blast_cache_misses == 4, "performance cache miss count unavailable");
        require(dst.performance.pipeline_wall_seconds == 6.25, "pipeline wall seconds unavailable");
        require(dst.performance.pipeline_construction_seconds == 3.75, "pipeline construction seconds unavailable");
        require(dst.performance.bam_stream_wall_seconds == 5.75, "BAM stream wall seconds unavailable");
        require(dst.performance.bin_processing_wall_seconds == 4.50, "bin processing wall seconds unavailable");
        require(dst.performance.finalization_seconds == 0.25, "finalization seconds unavailable");
        require(dst.performance.gate1_preliminary_seconds == 0.125, "gate1 seconds unavailable");
        require(dst.performance.exact_bin_scan_seconds == 0.375, "exact bin scan seconds unavailable");
        require(dst.performance.segmentation_edit_distance_calls == 11, "segmentation edit call count unavailable");
        require(dst.performance.segmentation_edit_distance_cache_hits == 7, "segmentation edit cache hit count unavailable");
        require(dst.performance.segmentation_seed_bins_total == 13, "segmentation seed bin count unavailable");
        require(dst.performance.segmentation_one_sided_searches == 2, "segmentation one-sided count unavailable");
    }
