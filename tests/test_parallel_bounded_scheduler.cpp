...
int main() {
    ...
    progress.worker_count = 6;
    progress.workers_waiting = 2;
    progress.max_task_elapsed_s = 1.25;
    ...
    assert(text.find("worker_count=6") != std::string::npos);
    assert(text.find("workers_waiting=2") != std::string::npos);
    assert(text.find("max_task_elapsed_s=1.25") != std::string::npos);
